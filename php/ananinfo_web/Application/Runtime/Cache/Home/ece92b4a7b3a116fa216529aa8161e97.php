                        ...
                        <?php if(is_array($postHotArr)): $i = 0; $__LIST__ = $postHotArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$postid): $mod = ($i % 2 );++$i;?><div class="col-sm-12 col-md-12">
                                <div class="single-blog single-column">
                                    <div class="post-thumb">
                                        <a href="/?c=Post&a=detail&postid=<?php echo ($postid["id"]); ?>">
                                        <img src="<?php echo ($postid["img_cover"]); ?>" class="img-responsive" alt=""></a>
                                        <!-- <div class="post-overlay">
                                           <span class="uppercase"><a href="#">14 <br><small>Feb</small></a></span>
                                       </div> -->
                                    </div>
                                     <div class="post-content overflow">
                                        <h2 class="post-title bold"><a href="blogdetails.html"><?php echo ($postid["title"]); ?></a></h2>
