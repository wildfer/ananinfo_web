...
import com.AnAnInfoCmd.util.SpringJdbcUtil;
...
//				}
	...
	public ArrayList queryDataForBeanByCondition(Class beanClass, String condition,
		...
		if (list != null && list.size() > 0) {
			...
			throw new CustomException(CustomException.SYSTEM_ERROR, "查询出错");
		}
		return listBean;
	}
	...
	public List<String> getAllColumnsByTableName(String tableName) throws CustomException{
		...
		try {
			...
			throw new CustomException(CustomException.SYSTEM_ERROR,       "系统错误,请重试");
		}finally{
			if(conn!=null){
				try {
					conn.close();
	...
	public void executeUpdate(String sql,String operateDesc) throws CustomException{
		try{
			...
			throw new CustomException(CustomException.SYSTEM_ERROR, operateDesc+"发生错误");
		}
	}
...
//	}
	...
	public int getLastInsertID() throws CustomException{
		...
		try {
			...
			throw new CustomException(CustomException.DATABASE_RUN_ERROR,"获取ID 错误");
		}
		return storeID;
	}
	...
	public int getCount(String key ,String table,String condition) throws CustomException{
		...
		try {
			...
			throw new CustomException(CustomException.DATABASE_RUN_ERROR,"获取数量 错误");
		}
		return cnt;
	}
	...
	public boolean isExist(String key ,String table,String condition) throws CustomException{
		...
		try {			
			...
			throw new CustomException(CustomException.DATABASE_RUN_ERROR,"查询出错,sql:"+sql);
		}
		if(cnt==0){
			return false;
		}
...
//		json.put("name", "abc");
//		json.put("when", 123);
//		String sql = dao.jsonToInsertsql(json,"member");
